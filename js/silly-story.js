...
var button=document.getElementById("rendomize");
var story=document.getElementById("paragraph");
/*  3: Create the variable that contains the story string that will be modified 
...
function result() {
    ...
    if (document.getElementById("metric").checked) {
        ...
        let weight = 300 * 0.453592; // convert lbs to kgs
    newStory = newStory.replace("300 pounds", weight.toFixed(2) + " kg");

    let temp = ((94 - 32) * 5/9).toFixed(2); // convert °F to °C
